...
import { closestByClassName, createElement, createElementTo, emptyElement } from '../utils/tools';
var PdfThumb = /** @class */ (function (_super) {
            ...
            if (this._index !== value) {
                ...
                scrollToElement(this.thumItemViews[value], {
                    getContainer: function () {
                        return document.querySelector('.ax-pdf-thum');
                    },
                });
            }
        },
    ...
    PdfThumb.prototype.init = function () {
        ...
        this.container.classList.add('ax-pdf-thum');
    ...
    PdfThumb.prototype.addThumCanvas = function (view, index) {
        ...
        if (thumItemView) {
            var wrap = createElementTo('div', thumItemView);
